...
void XmlParse::parse_header_attributes(nlohmann::json* input_json,
    ...
    do {
        ...
        remaining_header_string =
            header_string.substr(attribute_start_index,
                                 header_string_length - attribute_start_index);
        attribute_length = remaining_header_string.find(' ');
        attribute_string =
            header_string.substr(attribute_start_index, attribute_length);

        if (regex_match(attribute_string, attribute_key_value,
                        attribute_regex)) {
