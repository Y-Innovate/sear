...
nlohmann::json XMLParser::build_json_string(SecurityRequest& request) {
  ...
  Logger::getInstance().debug(
      "Raw EBCDIC encoded result XML:",
      Logger::getInstance().castHexString(request.p_result_->raw_result));
