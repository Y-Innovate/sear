...
void check_arg_pointers(char *raw_request, bool racf_options) {
  ...
  */
  ...
  int arg_area_size = TEST_GENERIC_ARG_AREA_SIZE;

  if (racf_options == true) {
    arg_area_size = TEST_RACF_OPTIONS_ARG_AREA_SIZE;
  }
...
void test_extract_request_generation(const char *test_extract_request_json,
  ...
  int request_buffer_size = TEST_GENERIC_REQUEST_BUFFER_SIZE;
  int arg_area_size       = TEST_GENERIC_ARG_AREA_SIZE;

  if (racf_options == true) {
    request_buffer_size = TEST_RACF_OPTIONS_REQUEST_BUFFER_SIZE;
    arg_area_size       = TEST_RACF_OPTIONS_ARG_AREA_SIZE;
  }
